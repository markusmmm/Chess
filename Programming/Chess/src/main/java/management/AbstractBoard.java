...
public class AbstractBoard {
    ...
    protected AbstractBoard(int size, int difficulty, boolean useClock, BoardMode mode) {
    ...
    protected AbstractBoard(File file, int difficulty, BoardMode mode) throws FileNotFoundException {
        loadBoard(file);
        this.difficulty = difficulty;
        this.mode = mode;
    }
    ...
    public void saveBoard(File file) {
        ...
        try {
            ...
            save.write(mode.toString() + " " + n + " " + difficulty + " 0 " + gameLog.size() + " " + moveI + "\n");
    ...
    public Alliance getActivePlayer() { return activePlayer; }
